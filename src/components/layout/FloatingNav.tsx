                ...
                return (
                  ...
                  >
                    <Link to={item.path} className="relative group">
                      ...
                      >
                        <div
                          className={`flex items-center gap-2 px-4 py-2.5 rounded-[16px] font-semibold transition-all duration-500 text-sm whitespace-nowrap relative ${
                            active
          ...
          <div className="relative flex items-center justify-around">
            {navItems.slice(0, 4).map((item, index) => {
              ...
              return (
                ...
                >
                  <Link to={item.path} className="relative p-2">
                    <motion.div
